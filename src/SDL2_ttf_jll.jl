...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import SDL2_ttf_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("ca9d4746-8a27-5104-babe-80f83b336947"))
platforms = [Pkg.Artifacts.unpack_platform(e, "SDL2_ttf", artifacts_toml) for e in artifacts["SDL2_ttf"]]
...
if best_platform === nothing
    @debug("Unable to load SDL2_ttf; unsupported platform $(triplet(platform_key_abi()))")
else
